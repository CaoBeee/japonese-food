...
export default function MenuSelections() {
    ...
    useEffect(() => {
        if (hasCookie('menu_selection_state')) {
            setSelection(getCookie('menu_selection_state'));
        }
        else {
            setSelection(1);
    ...
    return (
        <span className={styles.container}>
            <MenuText color={selection == 1 && '#ED5B55' || 'black'} fontSize={selection == 1 && 28 || 26} onClick={() => { setSelection(1), setCookie('menu_selection_state', 1); window.dispatchEvent(new Event("cookie")) }}
            ...
            <MenuText color={selection == 2 && '#ED5B55' || 'black'} fontSize={selection == 2 && 28 || 26} onClick={() => { setSelection(2), setCookie('menu_selection_state', 2); window.dispatchEvent(new Event("cookie")) }}
            ...
            <MenuText color={selection == 3 && '#ED5B55' || 'black'} fontSize={selection == 3 && 28 || 26} onClick={() => { setSelection(3), setCookie('menu_selection_state', 3); window.dispatchEvent(new Event("cookie")) }}
            ...
            <MenuText color={selection == 4 && '#ED5B55' || 'black'} fontSize={selection == 4 && 28 || 26} onClick={() => { setSelection(4), setCookie('menu_selection_state', 4); window.dispatchEvent(new Event("cookie")) }}
