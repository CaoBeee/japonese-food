			...
			{pageState == 1 && (
				<div className={styles.our_company}>
					...
					<p>
						...
						source only the finest seafood, vegetables, and rice available. Our talented sushi chefs
						craft each roll with precision and care, ensuring that every bite is a perfect balance
						of flavors and textures.
						<br />
						<br />
						But we're more than just a sushi restaurant - we're a community of food lovers who share
						a passion for great food and great company. We're dedicated to providing a warm,
						...
						tantalize your taste buds, we're sure you'll find something to love. We look forward to
						welcoming you to our restaurant and sharing our love of sushi with you.{' '}
					</p>
				</div>
			)}
			{pageState == 2 && (
				<div className={styles.our_products}>
					...
					<p>
						...
						add color and flavor to our sushi. We take great care in selecting the best produce, and
						our chefs work to create beautiful and delicious sushi rolls that showcase the natural
						flavors of each ingredient. <br />
						<br />
						At our sushi restaurant, we believe that the key to great sushi is starting with the
						best ingredients. That's why we're committed to using only the freshest, highest quality
						ingredients available. We're confident that you'll taste the difference in every bite.
					</p>
				</div>
			)}
			{pageState == 3 && (
				<div className={styles.rewards}>
					...
					<p>
						...
						free appetizers, and more. With every purchase you make, you'll earn points that can be
						redeemed for free sushi rolls, nigiri, and sashimi, as well as other exciting rewards.
						<br />
						<br />
